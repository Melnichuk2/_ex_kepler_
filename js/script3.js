...
async function fetchPlanets() {
    planets = {
        ...
        "Венера": { semiMajorAxis: 0.72, eccentricity: 0.0068 },
        "Земля": { semiMajorAxis: 1.0, eccentricity: 0.0167 },
        "Марс": { semiMajorAxis: 1.52, eccentricity: 0.0934 },
        "Юпітер": { semiMajorAxis: 5.20, eccentricity: 0.0484 },
        "Сатурн": { semiMajorAxis: 9.58, eccentricity: 0.0556 },
        "Уран": { semiMajorAxis: 19.22, eccentricity: 0.0472 },
        "Нептун": { semiMajorAxis: 30.05, eccentricity: 0.0086 }
    };
    return planets;
}
